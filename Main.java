...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        setStoreName("Microcenter");

        // 2) Complete the greetCustomer() method below
        String greeting = greetCustomer("Jordan");
    ...
    public static void setStoreName(String name) {
        ...
        //Updated value of mStoreName and we can access this variable because mStorenName is a global variable
        mStoreName = name;
    }
    ...
    public static double getBulkDiscount(int quantityPurchased) {
        ...
        int discountLevel = quantityPurchased / 5;
        for (int c = 1; c <= discountLevel; c++) {
            discount += +.05;
        }
        return discount;
    }
